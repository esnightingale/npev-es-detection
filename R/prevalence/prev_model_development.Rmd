...
where $M_{i,t}$ is the number of notified AFP cases and $p_{i,t}$ is the estimated prevalence of EV in this sampled population.
...
Other notes:
Based on Kroiss et al. analysis, NPEV prevalence among NP-AFP cases was around 25% per month. 
Assume EV prevalence among AFP cases similar?
