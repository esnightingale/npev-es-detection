...
outdir <- file.path("output", country)
...
# Selected model
fit_prior <- read_rds(here(outdir,"prevalence/fit_prior.rds"))
fit <- read_rds(here(outdir,"prevalence/fit_posterior.rds"))
