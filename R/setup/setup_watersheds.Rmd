...
dir.create(here(dir, "analysis", "detection"), recursive = TRUE, showWarnings = FALSE)
saveRDS(watershed, here(dir, "analysis", "detection", "watershed.rds"))
